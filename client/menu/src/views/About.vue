...
const emoji = ref(emojis[Math.floor(Math.random() * Math.floor(emojis.length))]);
...
const considerSupporting = sanitize(t('CONSIDER_SUPPORTING')).replace('{0}', '<a href="https://patreon.com/altvmp" tabindex="-1" target="_blank">' + sanitize(t('CONSIDER_SUPPORTING_LINK')) + '</a>');
            ...
            <div class="view__wrapper">
                ...
                <div class="view__columns">
                    <div class="view__list view__libraries">
                        ...
                        <block-container class="view__library library" v-for="lib in libs" @click="open(lib.source)">
                            <div class="library__title">{{ lib.name }} <a :href="lib.licenceLink" target="_blank" tabindex="-1" @click.stop="playMoveSound" @mouseenter="playHoverSound">{{ lib.licence }}</a></div>
                        ...
                        <p class="view__notice view__notice--lower">
                            ...
                            trademarks of Take-Two Interactive Software. Any trademarks used
                            belong to their respective owners. alt:V Multiplayer and altMP
                            Project are not affiliated with or endorsed by Take-Two
