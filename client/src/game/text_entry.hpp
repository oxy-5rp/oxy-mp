...
public:
    ...
    ///
    /// Набирают всегда в раскладке игрока: символ берётся из WM_CHAR, где
    /// Windows уже применила к нажатию раскладку, регистр и мёртвые клавиши.
    /// Собрать то же самое из кодов клавиш нельзя — вышла бы латиница и ничего
    /// больше.
    ///
    /// Раньше здесь был и второй набор, латиницей помимо раскладки: им вводили
    /// названия моделей игры в отладочном меню. Меню вырезано вместе со всеми
    /// правилами игры, которых у клиента быть не должно, — и вводить латиницей
    /// стало нечего.
    void begin();
