...
(function build(alt) {
    ...
    ///
    /// Заглушка здесь именно бросает, а не молчит: натив зовут ради дела, и
    /// сделанного вида хуже отказа. Зато отказ называет причину, а не «is not a
    /// function», и работает он в обе двери — и через `require`, и через
    /// `import * as`, потому что имя попадает в перечень.
