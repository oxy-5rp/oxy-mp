...
(function build(alt) {
    ...
    class WorldObject {
        ...
        set dimension(_value) {
            // Измерений нет ни на клиенте, ни на сервере, и это не пробел в
            // переводчике сущностей, а отдельная работа: раскладывать по ним
            // рассылку состояний обязан сервер. Отказ честнее молчания — режим,
            // разложивший игроков по измерениям и не узнавший, что их нет,
            // собрал бы всех в одной комнате.
